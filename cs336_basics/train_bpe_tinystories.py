...
def train_bpe_tinystories():
    start_time = time()
    vocab, merges = train_bpe(DATA_PATH / "TinyStoriesV2-GPT4-train.txt", 10000, ["<|endoftext|>"])
    end_time = time()
    ...
    save_merges(DATA_PATH / "TinyStoriesV2-GPT4-train.txt.bpe.merges.json", merges)
